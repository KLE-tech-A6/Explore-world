        ...
        >
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5">
              <h1 className="text-2xl font-bold text-[#32a3a9]">Explore World</h1>
            </Link>
          </div>
              ...
              <div>
                <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                  ...
                  <img
                    ...
                    src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fhuman%2F&psig=AOvVaw1djdgrb3L0S_RpzS6a1KOI&ust=1735558437734000&source=images&cd=vfe&opi=89978449&ved=0CBAQjRxqFwoTCMDFrJLxzIoDFQAAAAAdAAAAABAE"
                    alt=""
                  />
                </Menu.Button>
              </div>
        ...
        >
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-bold text-[#32a3a9]">Explore World</h1>
              <button
                type="button"
