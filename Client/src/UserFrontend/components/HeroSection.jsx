        ...
        >
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5">
              <h1 className="text-2xl font-bold text-[#fdf0d5]">
                Explore World
              </h1>
            </Link>
          </div>
        ...
        <div className=" mx-auto max-w-2xl py-32 sm:py-48 lg:py-36 ">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-[#fdf0d5] sm:text-6xl">
              One Of The Best Travel Guide in World
            </h1>
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Discover endless possibilities with our expertly curated travel
              experiences. From breathtaking destinations to hidden gems, we
              bring you the world’s best. Let us help you create memories that
